...
class Voyage
{
    ...
    {
        $voyage1 = new Voyage("IleMaurice", "Port Louis", "Située au nord-ouest du pays, Port-Louis ne vous laissera pas indifférent. Fondée par le gouverneur français Bertrand-François Mahé de Labourdonnais en 1735, la cité est le centre économique de l'île et une ville très animée en journée, grouillant de vie.");
    ...
    public static function getVoyagesParNom($pays){
        foreach (self::$voyages as $voyage) {
            if (strtolower($voyage->pays) === $pays) {
                return $voyage;
            }
        }
    }
